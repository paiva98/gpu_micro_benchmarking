...
compile_size = 64bit
	...
	.headerflags    @"EF_CUDA_SM70 EF_CUDA_PTX_SM(EF_CUDA_SM70)"
        ...
        /*0090*/                   IMAD.U32 R7, RZ, RZ, c[0x0][0x174];  /* 0x00005d00ff077624 */
                                                                        /* 0x000fe400078e00ff */
        /*00a0*/                   FADD R0, R2, R4;                     /* 0x0000000402007221 */
                                                                        /* 0x001fd00000000000 */
	...
	.headerflags    @"EF_CUDA_SM70 EF_CUDA_PTX_SM(EF_CUDA_SM70)"
        ...
        /*0090*/                   MOV R7, c[0x0][0x174];               /* 0x00005d0000077a02 */
                                                                        /* 0x000fe40000000f00 */
        /*00a0*/                   IADD3 R0, R2, R4, RZ;                /* 0x0000000402007210 */
                                                                        /* 0x001fd00007ffe0ff */
        /*00b0*/                   STG.E.SYS [R6], R0;                  /* 0x0000000006007386 */
                                                                        /* 0x0001e2000010e900 */
        /*00c0*/                   EXIT;                                /* 0x000000000000794d */
